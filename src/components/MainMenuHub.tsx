...
export const MainMenuHub: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-in fade-in duration-300">
      ...
      {/* Secondary Quick Links (Relatórios e Configurações) */}
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Métricas de tempo de espera (TME), produtividade e gráficos</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Ajuste do sintetizador de voz, toques sonoros e banco de dados</p>
            </div>
          </div>
          <ChevronRight className="w-5 h-5 text-slate-400" />
        </div>
